...
>样式：cid\_control\_expire\_\[vod\_time\]\_\[ip\]\_\[refer\]\_\[object_id\]\_digest

其中：
**cid\_control\_expire\_\[vod\_time\]\_\[ip\]\_\[refer\]\_\[object_id\]**为明文段，**[ ]**标记表示可选字段。
**digest**为验证码
...
**`注意`**: 4 和 5 位不能同时开启, 并且需要配合 0-3 位使用。
